...
import GUIComponent from 'vcloudblock-gui/src/components/gui/gui.jsx';
...
import {
    ...
    setProjectId
} from 'vcloudblock-gui/src/reducers/project-state';
import {
    openLoadingProject,
    closeLoadingProject,
    openTelemetryModal,
    openUpdateModal
} from 'vcloudblock-gui/src/reducers/modals';
import {setUpdate} from 'vcloudblock-gui/src/reducers/update';

import analytics, {initialAnalytics} from 'vcloudblock-gui/src/lib/analytics';
import MessageBoxType from 'vcloudblock-gui/src/lib/message-box.js';
